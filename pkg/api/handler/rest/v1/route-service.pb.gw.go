...
func request_RouteService_ReadAllRoutesForNodeAndRoute_0(ctx context.Context, marshaler runtime.Marshaler, client RouteServiceClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq ReadResponseForNodeRoute
	...
	val, ok = pathParams["route"]
	if !ok {
		return nil, metadata, status.Errorf(codes.InvalidArgument, "missing parameter %s", "route")
	}

	protoReq.Route, err = runtime.String(val)

	if err != nil {
		return nil, metadata, status.Errorf(codes.InvalidArgument, "type mismatch, parameter: %s, error: %v", "route", err)
	}

	msg, err := client.ReadAllRoutesForNodeAndRoute(ctx, &protoReq, grpc.Header(&metadata.HeaderMD), grpc.Trailer(&metadata.TrailerMD))
...
func request_RouteService_CreateRoute_0(ctx context.Context, marshaler runtime.Marshaler, client RouteServiceClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq CreateRequestRoute
	var metadata runtime.ServerMetadata
...
func RegisterRouteServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client RouteServiceClient) error {
	...
	mux.Handle("GET", pattern_RouteService_ReadAllRoutesForNodeAndRoute_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := request_RouteService_ReadAllRoutesForNodeAndRoute_0(rctx, inboundMarshaler, client, req, pathParams)
		...
		forward_RouteService_ReadAllRoutesForNodeAndRoute_0(ctx, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
...
var (
	pattern_RouteService_ReadAllRoutesForNodeAndRoute_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 1, 0, 4, 1, 5, 2, 2, 3, 1, 0, 4, 1, 5, 3}, []string{"v1", "nodes", "nodeId", "route"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_RouteService_CreateRoute_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"v1", "routes"}, "", runtime.AssumeColonVerbOpt(true)))
)

var (
	forward_RouteService_ReadAllRoutesForNodeAndRoute_0 = runtime.ForwardResponseMessage
